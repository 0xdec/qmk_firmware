...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______,_______,_______,_______,KC_PSCR,_______,_______,KC_LCBR,KC_RCBR,KC_PIPE,_______,KC_BSPC, \
...
/* Raise
 *,-----------------------------------------------------------------------------------------------.
 *|  ESC  |  F11  |  F12  |  F13  |  F14  |  F15  |  F16  |  F17  |  F18  |  F19  |  F20  |  DEL  |
 *|-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 *|       |       |       |       | PRTSCR|       |       |   {   |   }   |   |   |       | BKSPC |
 *|-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 *|       |       |       |       |       |       |       |   [   |   ]   |   \   |       |       |
...
[_RAISE] = LAYOUT_preonic_grid( \
  KC_ESC ,KC_F11 ,KC_F12 ,KC_F13 ,KC_F14 ,KC_F15 ,KC_F16 ,KC_F17 ,KC_F18 ,KC_F19 ,KC_F20 ,KC_DEL , \
  _______,_______,_______,_______,KC_PSCR,_______,_______,KC_LCBR,KC_RCBR,KC_PIPE,_______,KC_BSPC, \
  _______,_______,_______,_______,_______,_______,_______,KC_LBRC,KC_RBRC,KC_BSLS,_______,_______, \
  _______,_______,_______,_______,_______,KC_PAUS,KC_INS ,KC_MENU,_______,_______,_______,_______, \
